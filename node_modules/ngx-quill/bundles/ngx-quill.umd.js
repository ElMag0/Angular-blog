(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('quill'), require('@angular/platform-browser'), require('@angular/forms'),require('@angular/core'),require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-quill', ['exports', '@angular/common', '@angular/core', 'quill', '@angular/platform-browser', '@angular/forms','@angular/core','@angular/common'], factory) :
...
}(this, (function (exports, common, core, quill, platformBrowser, forms,ɵngcc0,ɵngcc1) { 
const _c0 = [[["", "quill-editor-toolbar", ""]]];
const _c1 = ["[quill-editor-toolbar]"];
const _c2 = [1, "ql-container", 3, "ngClass"];
const _c3 = [1, "ql-editor", 3, "innerHTML"];
'use strict';
...
QuillViewHTMLComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: QuillViewHTMLComponent, selectors: [["quill-view-html"]], factory: function QuillViewHTMLComponent_Factory(t) { return new (t || QuillViewHTMLComponent)(ɵngcc0.ɵɵdirectiveInject(platformBrowser.DomSanitizer), ɵngcc0.ɵɵdirectiveInject(QUILL_CONFIG_TOKEN)); }, inputs: { content: "content", theme: "theme" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], consts: 2, vars: 2, template: function QuillViewHTMLComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(QuillViewHTMLComponent, [{
        ...
        args: [{
                ...
                type: core.Inject,
                args: [QUILL_CONFIG_TOKEN]
            }] }]; }, { sanitizer: [], config: [], innerHTML: [], themeClass: [], content: [{
            type: Input
        }], ngOnChanges: [], theme: [{
            type: Input
        }] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(QuillModule, { declarations: [QuillEditorComponent,
        QuillViewComponent,
        QuillViewHTMLComponent], imports: [ɵngcc1.CommonModule], exports: [QuillEditorComponent,
        QuillViewComponent,
        QuillViewHTMLComponent] });
...
QuillModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function QuillModule_Factory(t) { return new (t || QuillModule)(); }, providers: [], imports: [[common.CommonModule]] });
        return QuillModule;
    }());
